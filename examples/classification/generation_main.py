...
from examples.classification.hrank_generation import main as hg_train
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cof_factor', type=int, default=1, help='cof factor')
    parser.add_argument('--dis_factor', type=int, default=1, help='dis factor')
    parser.add_argument('--rank_factor', type=int, default=1, help='rank factor')
    args, opts = parser.parse_known_args()
    cfg = EasyConfig()
    cfg.load(args.cfg, recursive=True)
    cfg.update(opts)
    cfg.cof_factor = args.cof_factor
    cfg.dis_factor = args.dis_factor
    cfg.rank_factor = args.rank_factor
    if cfg.seed is None:
